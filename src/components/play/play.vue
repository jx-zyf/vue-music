      ...
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            <span class="time time-l" v-text="formate(currentTime)"></span>
            <div class="progress-bar-wrapper">
              <progress-bar :percent="percent" :fullScreen="fullScreen" @percentChange="onPercentChange"></progress-bar>
            </div>
            <span class="time time-r" v-text="formate(currentSong.duration)"></span>
          </div>
          <div class="operators">
            ...
            <div class="icon i-right" @click="toggleLike(currentSong)">
              <i class="icon" :class="getLikeIcon(currentSong)"></i>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    formate(num) {
      ...
      const sec = this._pad(Math.floor(num % 60));
      return `${min}:${sec}`;
    },
    getLyric() {
      this.currentSong
    ...
    handleLyric({ lineNum, txt }) {
      ...
      if (lineNum > 5) {
        let toLine = this.$refs.lyricLine[lineNum - 5];
        this.$refs.lyricList.scrollToElement(toLine, 1000);
      } else {
    ...
    middleTouchMove(e) {
      ...
      const offsetWidth = Math.min(
        0,
        Math.max(-window.innerWidth, left + diffX)
      );
